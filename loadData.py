...
def loadDataAndEmbeddings(config,loadData,augment_data):
    ...
    if loadData == True:
        ...
        train_data = read_data_2016(FLAGS.train_data, source_count, source_word2idx, target_count, target_phrase2idx, FLAGS.train_path, augment_data, FLAGS.augmentation_file_path)
        print('reading test data...')
        test_data = read_data_2016(FLAGS.test_data, source_count, source_word2idx, target_count, target_phrase2idx, FLAGS.test_path, False, None)
