...
def main():
    ...
    with open(FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + 'embedding.txt',
              'w') as out_file:
    ...
    with open(FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(
            FLAGS.year) + 'embedding_withCLS_SEP.txt', 'w') as out_file:
        with open(FLAGS.bert_embedding_path) as in_file:
            for line in in_file:
                if not line.startswith('\n'):
                    out_file.write(line)
    ...
    unique_words_index = []
    with open(FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(
            FLAGS.year) + 'embedding_withCLS_SEP.txt') as bert_emb_sep:
    ...
    unique_voca_bert = []
    with open(FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(
            FLAGS.year) + 'embedding.txt') as bert_emb:
    ...
    for filenr in range(1, 8):
        ...
        sent_count = 0
        dollar_count = 0
        with open(FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_' + str(
                filenr) + '.txt', 'w') as out_file:
    ...
    lines_1 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_1.txt').readlines()
    lines_2 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_2.txt').readlines()
    lines_3 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_3.txt').readlines()
    lines_4 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_4.txt').readlines()
    lines_5 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_5.txt').readlines()
    lines_6 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_6.txt').readlines()
    lines_7 = open(
        FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_7.txt').readlines()
    ...
    for file in [FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + 'embedding.txt',
                 FLAGS.temp_bert_dir + 'BERT_base_' + '_' + FLAGS.da_type + '_' + str(
                     FLAGS.year) + 'embedding_withCLS_SEP.txt',
                 FLAGS.temp_bert_dir + 'unique' + '_' + FLAGS.da_type + '_' + str(FLAGS.year) + '_BERT_Data_' + str(
                     filenr) + '.txt',
